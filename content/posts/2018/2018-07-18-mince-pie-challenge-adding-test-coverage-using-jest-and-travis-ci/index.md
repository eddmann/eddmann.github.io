...
Following on from [adding Flow](../2018-07-09-mince-pie-challenge-setting-up-flow-with-babel-and-webpack/index.md) to the API project, I now wish to garner further confidence in the code by adding tests.
...
In the [previous article](../2018-07-09-mince-pie-challenge-setting-up-flow-with-babel-and-webpack/index.md) we delved into adding types to the user authentication handler abstraction.
